import { buildEventSchema } from '../eventSchemaBuilder';

describe('eventSchemaBuilder', () => {
  describe('buildEventSchema', () => {
    it('should build simple flat schema', () => {
      ...
      const result = buildEventSchema(schema);
    ...
    it('should be compatible with Object.freeze', () => {
      ...
      const result = Object.freeze(buildEventSchema(schema));
