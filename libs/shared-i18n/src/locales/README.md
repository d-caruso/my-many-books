...
### Any changes made to files in `apps/web-app/public/locales/` WILL BE OVERWRITTEN
...
### DON'T: Edit files in `apps/web-app/public/locales/`

Changes there will be lost on next sync!
...
### I accidentally edited files in web-app
