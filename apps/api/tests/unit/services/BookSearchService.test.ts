...
describe('BookSearchService', () => {
  ...
  test.each([
    ...
    [SEARCH_SORT_BY_FIELDS.CREATED_AT, SORT_DIRECTIONS.ASC, [2, 1, 3]],
    [SEARCH_SORT_BY_FIELDS.CREATED_AT, SORT_DIRECTIONS.DESC, [3, 1, 2]],
    [SEARCH_SORT_BY_FIELDS.UPDATED_AT, SORT_DIRECTIONS.ASC, [3, 2, 1]],
    [SEARCH_SORT_BY_FIELDS.UPDATED_AT, SORT_DIRECTIONS.DESC, [1, 2, 3]],
