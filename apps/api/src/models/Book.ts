...
export class Book extends IdBaseModel<BookAttributes> implements BookAttributes {
  ...
  // Sequelize magic methods for associations (automatically generated by belongsToMany)
  // These are here for TypeScript type checking only
  declare addAuthors: (authors: Author[]) => Promise<void>;
  declare addAuthor: (author: Author) => Promise<void>;
  declare setAuthors: (authors: Author[]) => Promise<void>;
  declare removeAuthors: (authors: Author[]) => Promise<void>;
  declare $get: (association: 'authors' | 'categories') => Promise<Author[] | Category[]>;

  declare addCategories: (categories: Category[]) => Promise<void>;
  declare addCategory: (category: Category) => Promise<void>;
